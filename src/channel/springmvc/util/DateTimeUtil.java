...
public class DateTimeUtil {
	...
	/**
	 *      * 取得当前系统时间，返回Java.util.Date类型      *      * @see java.util.Date     
	...
	/**
	 *      * 取得当前系统时间戳      *      * @see java.sql.Timestamp      * @return
	 * java.sql.Timestamp 系统时间戳     
	 */
	...
	/**
	 *      * 返回当前时间是上午还是下午      *      * @see Calendar.AM 0      * @see
	 * Calendar.PM 1      * @return     
	 */
	...
	/**
	 *      * 得到格式化后的日期，格式为yyyy-MM-dd，如2006-02-15      *      * @param currDate
	 *      *                要格式化的日期      * @see #getFormatDate(java.util.Date,
	 * String)      * @return String 返回格式化后的日期，默认格式为为yyyy-MM-dd，如2006-02-15     
	 */
	...
	/**
	 *      * 得到格式化后的日期，格式为yyyy年MM月dd日，如2006年02月15日      *      * @param
	 * currDate      *                要格式化的日期      * @see
	 * #getFormatDate(java.util.Date, String)      * @return String
	 * 返回格式化后的日期，默认格式为yyyy年MM月dd日，如2006年02月15日     
	 */
	 ...
	 *      * 得到格式化后的日期，格式为yyyy年MM月dd日，如2006年02月15日      *      * @param
	 * currDate      *                要格式化的日期      * @see
	 * #getFormatDate_CN(String)      * @return Date
	 * 返回格式化后的日期，默认格式为yyyy年MM月dd日，如2006年02月15日     
	 */
	...
	/**
	 *      * 得到格式化后的日期，格式为yyyy-MM-dd，如2006-02-15      *      * @param currDate
	 *      *                要格式化的日期      * @see #getFormatDate(String, String)
	...
	/**
	 *      * 得到格式化后的日期，格式为yyyy年MM月dd日，如2006年02月15日      *      * @param
	 * currDate      *                要格式化的日期      * @see #getFormatDate(String,
	 * String)      * @return 返回格式化后的日期，默认格式为yyyy年MM月dd日，如2006年02月15日     
	 */
	...
	/**
	 *      * 根据格式得到格式化后的日期      *      * @param currDate      *               
	 * 要格式化的日期      * @param format      *                日期格式，如yyyy-MM-dd     
	 * * @see java.text.SimpleDateFormat#format(java.util.Date)      * @return
	 * String 返回格式化后的日期，格式由参数<code>format</code>      *        
	 ...
	 * * @param currDate      *                要格式化的时间      * @see
	 * #getFormatDateTime(java.util.Date, String)      * @return String
	 * 返回格式化后的时间，默认格式为yyyy-MM-dd HH:mm:ss，如2006-02-15      *         15:23:45
	 *     
	 */
	...
	/**
	 *      * 得到格式化后的时间，格式为yyyy-MM-dd HH:mm:ss，如2006-02-15 15:23:45      *     
	 * * @param currDate      *                要格式环的时间      * @see
	 * #getFormatDateTime(String)      * @return Date 返回格式化后的时间，默认格式为yyyy-MM-dd
	 * HH:mm:ss，如2006-02-15 15:23:45     
	 */
	 ...
	 *      * 得到格式化后的时间，格式为yyyy-MM-dd HH:mm:ss，如2006-02-15 15:23:45      *     
	 * * @param currDate      *                要格式化的时间      * @see
	 * #getFormatDateTime(String, String)      * @return Date
	 * 返回格式化后的时间，默认格式为yyyy-MM-dd HH:mm:ss，如2006-02-15 15:23:45     
	 */
	 ...
	 *      * @param currDate      *                要格式化的时间      * @see
	 * #getFormatDateTime(java.util.Date, String)      * @return String
	 * 返回格式化后的时间，默认格式为yyyy年MM月dd日 HH:mm:ss，如2006年02月15日      *         15:23:45
	 *     
	 */
	 ...
	 *      * 得到格式化后的时间，格式为yyyy年MM月dd日 HH:mm:ss，如2006年02月15日 15:23:45      *
	 *      * @param currDate      *                要格式化的时间      * @see
	 * #getFormatDateTime_CN(String)      * @return Date
	 * 返回格式化后的时间，默认格式为yyyy年MM月dd日 HH:mm:ss，如2006年02月15日      *         15:23:45
	 *     
	 */
	...
	/**
	 *      * 根据格式得到格式化后的时间      *      * @param currDate      *               
	 * 要格式化的时间      * @param format      *                时间格式，如yyyy-MM-dd
	 * HH:mm:ss      * @see java.text.SimpleDateFormat#format(java.util.Date)
	 ...
	 *      * 根据格式得到格式化后的日期      *      * @param currDate      *               
	 * 要格式化的日期      * @param format      *                日期格式，如yyyy-MM-dd     
	 * * @see java.text.SimpleDateFormat#parse(java.lang.String)      * @return
	 * Date 返回格式化后的日期，格式由参数<code>format</code>      *        
	 * 定义，如yyyy-MM-dd，如2006-02-15     
	 */
	 ...
	 *      * 根据格式得到格式化后的时间      *      * @param currDate      *               
	 * 要格式化的时间      * @param format      *                时间格式，如yyyy-MM-dd
	 * HH:mm:ss      * @see java.text.SimpleDateFormat#parse(java.lang.String)
	...
	/**
	 *      * 获得两个Date型日期之间相差的天数（第2个减第1个）      *      * @param Date     
	 * *                first, Date second      * @return int 相差的天数     
	 */
	...
	/**
	 *      * 获得两个String型日期之间相差的天数（第2个减第1个）      *      * @param String     
	 * *                first, String second      * @return int 相差的天数     
	 */
	...
	/**
	 *      * @author lenghao      * @createTime 2008-8-5 下午01:57:09      * @param
	 * first      * @param second      * @return 获取两个Date之间的天数的列表     
	 */
	...
	/**
	 *      * 得到格式化后的当前系统日期，格式为yyyy-MM-dd，如2006-02-15      *      * @see
	 * #getFormatDate(java.util.Date)      * @return String
	 * 返回格式化后的当前服务器系统日期，格式为yyyy-MM-dd，如2006-02-15     
	 */
	 ...
	 *      * @see #getFormatDateTime(java.util.Date)      * @return String
	 * 返回格式化后的当前服务器系统时间，格式为yyyy-MM-dd HH:mm:ss，如2006-02-15      *        
	 * 15:23:45     
	 */
	...
	/**
	 *      * 得到格式化后的当前系统日期，格式为yyyy年MM月dd日，如2006年02月15日      *      * @see
	 * #getFormatDate(java.util.Date, String)      * @return String
	 * 返回当前服务器系统日期，格式为yyyy年MM月dd日，如2006年02月15日     
	 */
	 ...
	 *      * @see #getFormatDateTime(java.util.Date, String)      * @return
	 * String 返回格式化后的当前服务器系统时间，格式为yyyy年MM月dd日 HH:mm:ss，如2006年02月15日     
	 * *         15:23:45     
	 */
	...
	/**
	 *      * 得到系统当前日期的前或者后几天      *      * @param iDate      *               
	 * 如果要获得前几天日期，该参数为负数； 如果要获得后几天日期，该参数为正数      * @see
	 * java.util.Calendar#add(int, int)      * @return Date 返回系统当前日期的前或者后几天     
	 */
	...
	/**
	 *      * 得到日期的前或者后几天      *      * @param iDate      *               
	 * 如果要获得前几天日期，该参数为负数； 如果要获得后几天日期，该参数为正数      * @see
	 * java.util.Calendar#add(int, int)      * @return Date 返回参数
	 * <code>curDate</code>定义日期的前或者后几天     
	 */
	...
	/**
	 *      * 得到格式化后的月份，格式为yyyy-MM，如2006-02      *      * @param currDate     
	 * *                要格式化的日期      * @see #getFormatDate(java.util.Date,
	 * String)      * @return String 返回格式化后的月份，格式为yyyy-MM，如2006-02     
	 */
	...
	/**
	 *      * 得到格式化后的日，格式为yyyyMMdd，如20060210      *      * @param currDate     
	 * *                要格式化的日期      * @see #getFormatDate(java.util.Date,
	 * String)      * @return String 返回格式化后的日，格式为yyyyMMdd，如20060210     
	 */
	...
	/**
	 *      * 得到格式化后的当月第一天，格式为yyyy-MM-dd，如2006-02-01      *      * @param
	 * currDate      *                要格式化的日期      * @see
	 * java.util.Calendar#getMinimum(int)      * @see
	 * #getFormatDate(java.util.Date, String)      * @return String
	 * 返回格式化后的当月第一天，格式为yyyy-MM-dd，如2006-02-01     
	 */
	...
	/**
	 *      * 得到格式化后的下月第一天，格式为yyyy-MM-dd，如2006-02-01      *      * @param
	 * currDate      *                要格式化的日期      * @see
	 * java.util.Calendar#getMinimum(int)      * @see
	 * #getFormatDate(java.util.Date, String)      * @return String
	 * 返回格式化后的下月第一天，格式为yyyy-MM-dd，如2006-02-01     
	 */
	...
	/**
	 *      * 得到格式化后的当月最后一天，格式为yyyy-MM-dd，如2006-02-28      *      * @param
	 * currDate      *                要格式化的日期      * @see
	 * java.util.Calendar#getMinimum(int)      * @see
	 * #getFormatDate(java.util.Date, String)      * @return String
	 * 返回格式化后的当月最后一天，格式为yyyy-MM-dd，如2006-02-28     
	 */
	...
	/**
	 *      * 得到日期的前或者后几小时      *      * @param iHour      *               
	 * 如果要获得前几小时日期，该参数为负数； 如果要获得后几小时日期，该参数为正数      * @see
	 * java.util.Calendar#add(int, int)      * @return Date 返回参数
	 * <code>curDate</code>定义日期的前或者后几小时     
	 */
	...
	/**
	 *      * 判断日期是否在当前周内      *      * @param curDate      * @param compareDate
	 *      * @return     
	 */
	...
	/**
	 *      * 返回格式化的日期      *      * @param datePre      *               
	 * 格式"yyyy-MM-dd 23:59:59";      * @return     
	 */
	 ...
	 *      * <li>4.将3个8位的16进制串合并成一个串，中间以","分割。</li>      *      * @param
	 * timespan      *               
	 * 一个48位的二进制串，如："011111111011111111111111111111111111111111111110"      * @return
	...
	/**
	 *      * 进行时段格式转换，将输入的26位的2进制串转换成48位的二进制串。      *      * @param timespan
	 *      *                一个16进制串，每位间以","分割。如："3fffcfff,ffffffff,fffffffc"
	 *      * @return      *        
	...
	/**
	 *      * 进行时段格式转换，将输入的32位的10进制串转换成48位的二进制串。      *      * @param timespan
	 *      *               
	 * 一个16进制串，每位间以","分割。如："1234567890,1234567890,1234567890c"      * @return
	 *      *        
	 * 一个48位的二进制串，如："011111111011111111111111111111111111111111111110"     
	 */
	 ...
	 * timespan      *               
	 * 一个48位的二进制串，如："011111111011111111111111111111111111111111111110"      * @return
	 * 一个16进制串，每位间以","分割。如："1234567890,1234567890,1234567890"     
	 */
	...
	/**
	 *      * 计算指定日期+addMonth月+15号 返回格式"2008-02-15"      *      * @param date
	 *      * @param addMonth      * @param monthDay      * @return     
	 */
	...
	/**
	 *      * 获得给定时间若干秒以前或以后的日期的标准格式。      *      * @param curDate      * @param
	 * seconds      * @return curDate     
	 */
	...
	/**
	 *      * 获得给定日期当天23点59分59秒的标准格式。      *      * @param curDate      * @return
	 * curDate     
	 */
	...
	/**
	 *      * alahan add 20050825 获取传入时间相差的日期      *      * @param dt     
	 * *                传入日期，可以为空      * @param diff      *               
	 * 需要获取相隔diff天的日期 如果为正则取以后的日期，否则时间往前推      * @return     
	 */
	...
	/**
	 *      * 取得多个日期中间隔的最大天数      *      * @author Alvise      * @param
	 * startDateAndEndDate      * @return     
	 */
	 ...
	 *      *      * @author Alvise      * @param startDateAndEndDate      * @return
	 *     
	 */
	...
	/**
	 *      * 判断时间段1和时间段2是否有交集      * @param begintimeOne      * @param
	 * endtimeOne      * @param begintimeTwo      * @param endtimeTwo      * @return
	 * true:有交集,false:没有交集     
	 */
